...
Gli algoritmi di apprendimento supervisionato vengono utilizzati per risolvere problemi di classificazione e di regressione, che analizzeremo rispettivamente in \ref{classificazione} e \ref{regressione}.
...
\end{align}
\end{subequations} % vedere come mettere le graffe
