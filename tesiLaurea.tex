...
p(C_k)&=&\frac{N_k}{N}
\end{eqnarray}
quindi la formula del Teorema di Bayes diventa:%segnarsi da qualche parte la dimostrazione
\begin{equation}
...
%inserire foto delle schermate dell'output a confronto
\clearpage
